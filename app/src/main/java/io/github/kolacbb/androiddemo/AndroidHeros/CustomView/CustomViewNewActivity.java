...
public class CustomViewNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_view_new);
        rootView = (ViewGroup) findViewById(R.id.root_view);
//        CircleCustomView circleCustomView = new CircleCustomView(this);
        QQHealthView qqHealthView = new QQHealthView(this);
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(250, 250);
        qqHealthView.setLayoutParams(params);
        rootView.addView(qqHealthView);
//        circleCustomView.setLayoutParams(params);
//        rootView.addView(circleCustomView);
    }

    private class CircleCustomView extends View {
        ...
        private void init() {
            ...
            //圆弧的画笔
            mArcPaint = new Paint();
            mArcPaint.setColor(Color.BLUE);//画笔颜色
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            Log.i("CircleCustomView", "width: " + width + " height: " + height);
        }

        /**
         * 当View的高宽确定后，设置View内图形的比例
         */
        @Override
        protected void onSizeChanged(int w, int h, int oldw, int oldh) {
            ...
            // 设置圆心
            mArcCenterX = (int) (0.5f * mWidth);
            mArcCenterY = (int) (0.3f * mHeight);

            // 设置圆弧外接矩形(正方形：边长0.5w)
            mArcRect = new RectF();
            mArcRect.left = 0.25f * mWidth;
            mArcRect.right = 0.75f * mWidth;
            mArcRect.top = 0.1f * mHeight;
            mArcRect.bottom = mArcRect.top + 0.5f * mWidth;

            // 获取画笔宽度
            mArcWidth = (int) (0.045f * mWidth);
            mBarWidth = (int) (0.035f * mWidth);
    ...
    class QQHealthView extends View {

        private String TAG = "QQHealthView";
